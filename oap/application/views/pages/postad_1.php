...
<div class="row">
    <form id="smart-form" method="POST" enctype='multipart/form-data' action="<?php echo base_url() . 'home/do_uploaad/' . base64_encode('newAdd'); ?>">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 register-account card">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <select id="AddType" name="premType">
                        ...
                        <option value="1">PREMIUM LISTING 1: KES. 2,500 for 7 Days</option>
                        <option value="2">PREMIUM LISTING 2: KES. 5,000 for 14 Days</option>
                        <option value="3">PREMIUM LISTING 3: KES. 10,000 for 30 Days</option>
                    </select>
                </div>	
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <button  type="submit" class="btn btn-primary" onclick="$(this).prop('text','Posting....')"><i class="fa fa-save"></i> Submit Listing</button>
            </div>
            <div class="row">
