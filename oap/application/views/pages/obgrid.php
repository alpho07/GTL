    ...
    <?php foreach ($flist as $ob): ?>
        <div class="col-lg-3 col-md-3 col-sm-3 product ">
            ...
            <div class="product-image" >
                <a href="<?php echo base_url() . 'home/loadprofile/' . $ob->id . '/' . str_replace(" ", "-", $ob->title); ?>">
            ...
            <div class="product-info card">
                <h5><a href="<?php echo base_url() . 'home/loadprofile/' . $ob->id . '/' . str_replace(" ", "-", $ob->title); ?>"><?php echo mb_strimwidth($ob->title , 0, 22, "..."); ?></a></h5>
                <span class=><small><?php echo $ob->obtitle ?></small></span>
            </div>
