                                    ...
                                    <tr >
                                        ...
                                        <td><a href="<?php echo base_url() . $ad->idcopy; ?>">View<a></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($ad->sms_pay == '0') { ?>
                                                            <a class="btn btn-warning confirm" data-toggle="modal" data-target="#myModal" data-name="<?php echo $ad->obtitle;?>"  id="<?php echo $ad->id; ?>" href="#?/<?php echo $ad->id . '/' . str_replace(" ", "-", $ad->title); ?>"><i class="fa fa-money"></i> Confirm</a>


                                                        <?php } else { ?>
                                                            <a class="btn btn-success "  id="<?php echo $ad->id; ?>" href="#?/<?php echo $ad->id . '/' . str_replace(" ", "-", $ad->title); ?>"><i class="fa fa-check-circle-o"></i> SMS Paid</a>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-danger deletead" data-id="<?php echo $ad->id; ?>" href="#delete-obituary"><i class="fa fa-trash"></i> Delete</a></td>
                                                    ...
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>You are about to confirm receipt of payment for (OBID: <span id="OBID"></span> &#187 Deceased: <span id="NAME"></span>) obituary for bulk SMS sending. Activation code will be sent to the Author. Do you want to continue? Enter Amount Paid by client</p>
    ...
    $(document).on('click', '#campaid', function () {
       // var id = $(this).attr('id');
        ...
        if (r === '') {
            ...
            alert('Operation Cancelled. Reason: Minimum amount Kes. 100');
        } else {
            //  alert('Success');
