    ...
    <div class="container card searchxlass " id="searchxlass" style="margin-top:120px; padding: 30px; background: #000; border: 1px solid #9e1461;" >
        <div class="col-md-12">
            <ul class="SEARCHER_LIST ">
                ...
                <li>
                    <input type="text" class="form-control SEARCHER" name="keywords" style="width:460px;border-radius: 0px !important;" placeholder="What are you looking for?"/>
                </li>
                <li>
                    <select class="chosen-select-search LOCALITY "  >
                        <option value="">All Locations</option>
                        <?php foreach ($locations as $l): ?>
                            <option value="<?php echo $l->region; ?>"><?php echo $l->region; ?></option>
                ...
                <li class="LISTT">
                    <input type="text" class="form-control  MIN" name="min" style="width:130px;border-radius: 0px !important;" placeholder="MIN"/>
                </li>
                <li>
                    <input type="text" class="form-control MAX" name="keywords" style="width:130px;border-radius: 0px !important;" placeholder="MAX"/>
                </li>
                <li>
...
<?php if ($this->uri->segment(2) == ''): ?>
    <div class="container CATEGORIES card" style=" padding: 10px;">
        ...
        <div class="row" style="margin-top:310px;">
            ...
            <div class="row col-xs-2" style="margin-top:30px;">
                ...
                <div id="myGallery2">
                    ...
                    <img src="<?php echo base_url(); ?>img/sidebar-slide1.jpg"  width="450px" height="400px " onclick="window.location.href = '#as2'"/>
                    <img src="<?php echo base_url(); ?>img/sidebar-slide2.jpg" width="450px" height="400px" onclick="window.location.href = '#as3'" />
                    <img src="<?php echo base_url(); ?>img/sidebar-slide3.jpg" width="450px" height="400px" onclick="window.location.href = '#as3'" />
                </div>
